...
7. Verify manifest paths, repository identity, command help, and asset licenses.
8. Report findings by severity with file and line references; state remaining
