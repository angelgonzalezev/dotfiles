...
8. Record the source, license, and trademark ownership of added visual assets.
9. Run `bin/bbldr-dotfiles check` and inspect all generated links in a temporary
